...
export const getPost = createPromiseThunk(REQUEST_POST, postsAPI.getPostById);
...
export default function repackThunkPosts(state = initialState, action) {
  switch (action.type) {
    ...
    case REQUEST_POSTS_ERROR:
      return handleAsyncActions(REQUEST_POSTS, "posts")(state, action);
    case REQUEST_POST:
    case REQUEST_POST_SUCCESS:
    case REQUEST_POST_ERROR:
      return handleAsyncActions(REQUEST_POST, "post")(state, action);
    default:
      return state;
  }
}
